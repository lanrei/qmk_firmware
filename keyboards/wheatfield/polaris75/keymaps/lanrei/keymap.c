...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * ,--------------------------------------------------------------------.     
   * |Esc| F1| F2| F3| F4|  | F5| F6| F7| F8|   |F9|F10|F11|F12| F14| PScrn|
   * `--------------------------------------------------------------------'
   * ,--------------------------------------------------------------------. 
   ...
   * ---------------------------------------------------------------------|
   * | Ctrl | GUI  | Alt |      Space           | RGUI| Fn| left| Dn| Rght|
   * ---------------------------------------------------------------------'
   */

	KEYMAP(
		KC_ESC, KC_F1, KC_F2, KC_F3, KC_F4,  KC_F5, KC_F6, KC_F7, KC_F8, KC_F9, KC_F10, KC_F11, KC_F12,  KC_F14,  KC_PSCR,  \
